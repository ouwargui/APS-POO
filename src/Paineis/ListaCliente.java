...
public class ListaCliente extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        System.out.println(cliente.getListaClientes().size());
        String[] colunas = {"Numero", "Nome", "CPF", "Telefone"};
        String[][] dados = new String[cliente.getListaClientes().size()][colunas.length];
        int i = 0;
        for (Cliente objContas : cliente.getListaClientes()) {
            String[] dadosUsuario = new String[colunas.length];
            dadosUsuario[0] = "" + objContas.getNumero();
            dadosUsuario[1] = objContas.getNome();
            dadosUsuario[2] = objContas.getCpf();
            dadosUsuario[3] = objContas.getTelefone();
